...
INSERT INTO e3_3 VALUES (2003, 2003, 'e331_2', 10011);
...
-- adjust alphabet case in one of the edges to test collation specified in the
-- expression
UPDATE e3_3 SET ename = 'E331' WHERE eprop1 = 10011;
