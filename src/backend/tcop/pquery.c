				...
				int instrument_options)
{
	...
	qd->cachedplan = cachedplan;	/* CachedPlan supplying the plannedstmt */
 ...
 *	cachedplan: CachedPlan supplying the plan
			 ...
			 QueryCompletion *qc)
{
	 ...
	 */
	queryDesc = CreateQueryDesc(plan, cachedplan, sourceText,
