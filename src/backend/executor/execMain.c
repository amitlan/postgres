 ...
 * ExecutorStart().  If that happens, a new CachedPlan is created only for the
 * query at the index 'query_index' in plansource->query_list, whose lifetime
 * is managed separately from the original CachedPlan.
 */
void
