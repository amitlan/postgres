 ...
 * relations are locked. The CachedPlanSource remains valid since only child
 * relations added during planning are prunable and locked during executor
 * initialization.
 */
