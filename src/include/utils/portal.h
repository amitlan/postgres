...
typedef struct PortalData
{
	...
	CachedPlanSource *plansource;	/* CachedPlanSource backing cplan, if any;
									 * kept so the portal can refetch a fresh
									 * plan if cplan is invalidated while
									 * acquiring execution locks */
